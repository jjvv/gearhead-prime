...
class Terrain(yaml.YAMLObject):
    ...
    def __init__(self, name, roguechar, graphic,
        ...
        self.graphic = graphic
            #TODO: 'graphic' is probably not the best name for this 'sprite descriptor tuple'
...
void = Terrain("void", " ",     ('void',[]),   passable=False)
floor = Terrain("floor", ".",   ('floor',[]))
wall = Terrain("wall", "#",     ('wall',[]), passable=False, opaque=True)
